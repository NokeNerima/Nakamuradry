...
(function() {
    ...
    enchant.Core = enchant.Class.create(enchant.EventTarget, {
         ...
         * @name enchant.Core
         * @class
         * A class for controlling the coreçª¶å†± main loop and scenes.
         *
...
enchant.Node = enchant.Class.create(enchant.EventTarget, {
    ...
    initialize: function() {
        ...
        // Nodeç¸ºæªŽå‡½è¬ŒèˆŒï¼†ç¹§å¾Œï½‹é««å¸™â†“, tl ç¹åŠ±ÎŸç¹ä»£ãƒ¦ç¹§ï½£ç¸ºï½« Timeline ç¹§ï½ªç¹æ‚¶ãšç¹§ï½§ç¹§ï½¯ç¹åŒ»ï½’éœ‘ï½½èœ‰ ç¸ºåŠ±â€»ç¸º„ãï½‹.
...
enchant.Timeline = enchant.Class.create(enchant.EventTarget, {
 ...
 ï¾‚ ï¾‚ ï¾‚ ï¾‚ * Time-line class has a method to add a variety of actions to himself,
 ï¾‚ ï¾‚ ï¾‚ ï¾‚ * entities can be animated and various operations by using these briefly.
 ï¾‚ ï¾‚ ï¾‚ ï¾‚ * You can choose time based and frame based(default) animation.
...
enchant.Action = enchant.Class.create(enchant.ActionEventTarget, {
     ...
     * @name enchant.Action
     * @class
ï¾‚ ï¾‚ ï¾‚ ï¾‚ ï¾‚ * Actions are units that make up the timeline.
ï¾‚ ï¾‚ ï¾‚ ï¾‚  * It is a unit used to specify the action you want to perform.
ï¾‚ ï¾‚ ï¾‚ ï¾‚  * 
ï¾‚ ï¾‚ ï¾‚ ï¾‚  * Actions that have been added to the timeline are performed in sequential order.
ï¾‚ ï¾‚ ï¾‚ ï¾‚  * The transition from one action to the next occurs automatically 
ï¾‚ ï¾‚ ï¾‚ ï¾‚  * after the number of frames specified by the time parameter have elapsed.
ï¾‚ ï¾‚ ï¾‚ ï¾‚  *
ï¾‚ ï¾‚ ï¾‚ ï¾‚  * An actionstart event is fired when the action has started.
ï¾‚ ï¾‚ ï¾‚ ï¾‚  * An actionend event is fired when the action has stopped.
ï¾‚ ï¾‚ ï¾‚ ï¾‚  * For each frame that elapses, an actiontick event is fired.
ï¾‚ ï¾‚ ï¾‚ ï¾‚  * 
ï¾‚ ï¾‚ ï¾‚ ï¾‚  * You can specify a listener for these events to perform specific events when they occur.
     *
     * @param {Object} param
